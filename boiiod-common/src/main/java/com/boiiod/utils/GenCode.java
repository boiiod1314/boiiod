...
//		list1 = getBeanName();
    ...
    private static void entityAddJsonIgnore() throws Exception {
        File file = new File("src/main/java/com/boiiod/entity");
        ...
        for (File f : files) {
            ...
            if (!name.contains("Example")) {
                ...
                File file_output = new File("src/main/java/com/boiiod/entity", name);
    ...
    private static void writeServiceImplCls(List<String> listBeanName, String dir) throws Exception {
        ...
        for (String beanName : listBeanName) {
			 ...
			 * 包
			 */
            sb.append("package com.boiiod.service.impl;");
            sb.append("\r\n\r\n");
			/*
			 * 导包
			 */
            ...
            sb.append("\r\n\r\n");
            sb.append("import com.boiiod.entity.");
            sb.append(beanName);
            sb.append(";\r\n");
            sb.append("import com.boiiod.entity.");
            sb.append(beanName);
            sb.append("Example;");
            sb.append("\r\n");
            sb.append("import com.boiiod.mapper.");
            sb.append(beanName);
            sb.append("Mapper;");
            sb.append("\r\n");
            sb.append("import com.boiiod.service.");
            sb.append(beanName);
            sb.append("Service;");
            sb.append("\r\n\r\n");
			/*
    ...
    private static void writeServiceInterface(List<String> listBeanName, String dir) throws Exception {
        ...
        for (String beanName : listBeanName) {
			 ...
			 * 包
			 */
            sb.append("package com.boiiod.service;");
            sb.append("\r\n\r\n");
			/*
			 * 导包
			 */
