/**
 * Created by boiiod on 2017/2/22.
 */
...
$(function () {
    var fnSaveOrUpdateNote = function (noteId, noteContentId, noteContent) {
        ...
        if (noteId) {
            ...
            if (isValFalse(noteTitle)) {
                boiiodMsgAlertAutoClose("标题不能为空!", 2000);
                return;
            }
    ...
    boiiodEditor = editormd("boiiod-editormd-edit-note", {
        width: "100%",
        height: height,
        ...
        onload: function () {
            ...
            $('#J_save_note').click(function () {
                if (!boiiodMsgConfirm("点击确定保存笔记")) return;
